...
abstract contract StdChains {
    ...
    function initializeStdChains() private {
        ...
        setChainWithDefaultRpcUrl("mantle_one", ChainData("mantle One", 42161, "https://arb1.mantle.io/rpc"));
        setChainWithDefaultRpcUrl(
            "mantle_one_sepolia", ChainData("mantle One Sepolia", 421614, "https://sepolia-rollup.mantle.io/rpc")
        );
        setChainWithDefaultRpcUrl("mantle_nova", ChainData("mantle Nova", 42170, "https://nova.mantle.io/rpc"));
