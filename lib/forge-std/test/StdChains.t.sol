...
contract StdChainsTest is Test {
    function test_ChainRpcInitialization() public {
        ...
        assertEq(getChain("mantle_one_sepolia").rpcUrl, "https://sepolia-rollup.mantle.io/rpc/");

        // Environment variables should be the next fallback
        assertEq(getChain("mantle_nova").rpcUrl, "https://nova.mantle.io/rpc");
        vm.setEnv("mantle_NOVA_RPC_URL", "myoverride");
        assertEq(getChain("mantle_nova").rpcUrl, "myoverride");
        vm.setEnv("mantle_NOVA_RPC_URL", "https://nova.mantle.io/rpc");
    ...
    //     _testRpc("mantle_one");
    //     _testRpc("mantle_one_sepolia");
    //     _testRpc("mantle_nova");
    //     _testRpc("polygon");
